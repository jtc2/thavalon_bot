...
def get_role_description(role):
	return {
		...
		'Maeve' 		: "Once per round (except the first), during a vote on a proposal, you can secretly choose to obscure how each player voted on the proposal and instead have only the amount of upvotes and downvotes presented. \nLike other Evil characters, you know who else is Evil (except Colgrevance).",
